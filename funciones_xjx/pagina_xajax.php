...
function ingresar($form) {
	...
	$sqlInsert = "insert into pagina (descripcion,pagina,activo, menu, codigo_padre, padre) values";

	$sqlInsert .= "('$descripcion','$pagina','1','$menu',$codigo_padre,$espadre);";
...
function seleccionar($id) {
	...
	$objResponse -> assign("activo", "value", "$ln[3]");

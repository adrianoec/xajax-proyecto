...
function ingresar($form) {
    ...
    $objDB->getConexion();
    $objResponse = new xajaxResponse();
    $sqlInsert = "insert into tipo_comprador (descripcion,codigo_sri) values";
...
function actualizar($form) {
    ...
    $objDB->getConexion();
    $objResponse = new xajaxResponse();
    $sqlUpdate = "update  tipo_comprador set  descripcion= '$descripcion'
...
function eliminar($form) {
    ...
    $sqlUpdate = "update  tipo_comprador set  where  codigo= '$codigo_tipo_impuesto'
";
    $rs = $objDB->query($sqlUpdate);
...
function seleccionar($id) {
    ...
    $objDB->setParametrosBD(HOST, BASE, USER, PWD);
    $objDB->getConexion();
    $sql = " select *    from tipo_comprador
    where  codigo  = '$id' ";

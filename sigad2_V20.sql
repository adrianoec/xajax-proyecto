...
/* Created on:     25/01/2014 22:20:49                          */
/*==============================================================*/
...
comment on column Comprobante.Total_Descuento is
...
create table Emisor (
   ...
   Es_Contribuyente_Especial CHAR(1)              null,
   Lleva_Contabilidad   CHAR(1)              null,
...
/*==============================================================*/
create  index ASSOCIATION7_FK on Emisor (
codigo_tipo_emision
);
...
create table comprobante_modifica (
   codigo_Comprobante   SERIAL               null,
   codigo_comprobante_modifica INT4                 null,
...
alter table Emisor
   add constraint FK_EMISOR_ASSOCIATI_TIPO_EMI foreign key (codigo_tipo_emision)

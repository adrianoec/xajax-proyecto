...
/* Created on:     27/03/2014 21:39:35                          */
/*==============================================================*/
...
create table Comprobante (
   ...
   subtotal_no_impuesto NUMERIC              null,
...
create table Impuestos_Comprobante (
   codigo               SERIAL not null,
   Codigo_Comprobante_Detalle INT4                 null,
...
comment on column Impuestos_Comprobante.Codigo_Comprobante_Detalle is
'Es el código identificador del detalle de la factura';
...
alter table Impuestos_Comprobante
   add constraint FK_IMPUESTO_REFERENCE_COMPROBA foreign key (Codigo_Comprobante_Detalle)
